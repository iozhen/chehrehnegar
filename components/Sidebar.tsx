...
const Sidebar = () => {
  ...
  return (
    <div className="w-[17.6%] bg-white pl-[34px] relative overflow-auto custom-scroll pb-[20px]">
      <Link href="/">
        <div className="flex items-center gap-[14px] h-[9.7vh] sticky top-0 bg-white z-10 shadow-[0_0_10px_10px_rgba(0,0,0,0.1)]">
          <img
        ...
        {data.items.map((item) => (
          <div
            ...
            className={`w-full rounded-[20px] flex items-center justify-center h-[5.46vh] relative bg-center bg-contain px-[10px]  ${
              activeLayer === item.title ? "border-[#4379EE] border-[5px] " : ""
            }`}
            style={{
